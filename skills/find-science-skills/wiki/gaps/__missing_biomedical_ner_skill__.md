...
skill_id: "__missing_biomedical_ner_skill__"
quality_score: 0
...
## 缺口定位
- Gap ID：`__missing_biomedical_ner_skill__`
- 状态：`missing_skill`
- 期望行为：Recommend a biomedical NER or information-extraction skill rather than literature-search or writing skills.
...
## 查询样例
- `named entity recognition biomedical NLP`
