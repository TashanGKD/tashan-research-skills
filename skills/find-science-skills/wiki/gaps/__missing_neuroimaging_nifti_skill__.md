---
title: "Neuroimaging NIfTI / MRI / fMRI analysis"
type: skill_gap
tags: ["registry-gap", "missing_skill"]
date: 2026-07-07
updated: 2026-07-07
confidence: gap_backlog
skill_id: "__missing_neuroimaging_nifti_skill__"
quality_score: 0
registry_gap_status: "missing_skill"
---

# Neuroimaging NIfTI / MRI / fMRI analysis

## 缺口定位
- Gap ID：`__missing_neuroimaging_nifti_skill__`
- 状态：`missing_skill`
- 期望行为：Recommend a neuroimaging/NIfTI skill when one is present, or clearly report a registry gap instead of generic data-analysis matches.
